package com.ansj.demo.dto.security;
...
public record BoardPrincipal(
    ...
    public static BoardPrincipal of(String username, String password, String email, String nickname, String memo, Map<String, Object> oAuth2Attributes) {
        ...
        Set<SimpleGrantedAuthority> simpleGrantedAuthorities = roleTypes.stream()
                .map(RoleType::getName)
                .map(SimpleGrantedAuthority::new)
                .collect(Collectors.toUnmodifiableSet());
        return new BoardPrincipal(username, password, simpleGrantedAuthorities, email, nickname, memo, oAuth2Attributes);
    }
